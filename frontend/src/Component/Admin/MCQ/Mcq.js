        ...
        <div className='col'>
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="text" className="form-control" value={newQuestion} onChange={handleQuestionChange} required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" value={correctOption} onChange={handleCorrectOptionChange} required />
            </div>
